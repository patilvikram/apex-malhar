...
public interface PythonApexStream<T> extends ApexStream<T>
{
   ...
   */
  <STREAM extends ApexStream<T>> STREAM map(byte[] serializedFunction, Option... opts);
   ...
   * @return new stream of type T
   */
  <STREAM extends ApexStream<T>> STREAM flatMap(byte[] serializedFunction, Option... opts);
   ...
   * @return new stream of type T
   */
  <STREAM extends ApexStream<T>> STREAM filter(byte[] serializedFunction, Option... opts);
